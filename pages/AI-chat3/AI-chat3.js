Page({
  ...
  onLoad() {
    // 初始化，加载保存的会话记录
    const savedConversation = wx.getStorageSync('currentConversation3') || null;
  ...
  saveCurrentConversation() {
    ...
    const currentConversation3 = { conversationId, messages };
    wx.setStorageSync('currentConversation3', currentConversation3);
  },
  ...
  loadConversation(e) {
    ...
    wx.setStorageSync('currentConversation3', { conversationId, messages });
    wx.showToast({
      title: '会话已加载',
      icon: 'success'
    });
